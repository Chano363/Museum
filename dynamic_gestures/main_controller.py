...
class MainController:
    ...
    def __init__(
        self, detection_model, classification_model, max_age=30, min_hits=3, iou_threshold=0.3, maxlen=30, min_frames=20,confidence_threshold=0.5
    ):
        """
        Parameters
        ----------
        ...
        self.tracks = []
        self.frame_count = 0
        self.detection_model = HandDetection(detection_model,confidence_threshold=confidence_threshold)
